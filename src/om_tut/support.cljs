...
(defn version-buttons [owner]
  (dom/div #js {:className "btn-group audyx-app-version"}
           (dom/button #js {:type "button" :className "btn btn-default" :onClick #(om/transact! (:version owner) "version2_4")}
                       (dom/h4 nil "{{ formatDate('2022-3') }}"
                               (dom/i #js {:className "fa fa-check"}))
                       (dom/h5 nil "2.4.0.0"))
           (dom/button #js {:type "button" :className "btn btn-default" :onClick #(om/transact! (:version owner) "version2_3")}
                       (dom/h4 nil "{{ formatDate('2021-5') }}"
                               (dom/i #js {:className "fa fa-check"}))
                       (dom/h5 nil "2.3.0.0"))
           (dom/button #js {:type "button" :className "btn btn-default" :onClick #(om/transact! (:version owner) "version2_2")}
                       (dom/h4 nil "{{ formatDate('2020-9') }}"
                               (dom/i #js {:className "fa fa-check"}))
                       (dom/h5 nil "2.2.0.0"))
           (dom/button #js {:type "button" :className "btn btn-default" :onClick #(om/transact! (:version owner) "version2_1")}
                       (dom/h4 nil "{{ formatDate('2020-6') }}"
                               (dom/i #js {:className "fa fa-check"}))
                       (dom/h5 nil "2.1.0.0"))
           (dom/button #js {:type "button" :className "btn btn-default" :onClick #(om/transact! (:version owner) "version1_22")}
                       (dom/h4 nil "{{ formatDate('2020-1') }}"
                               (dom/i #js {:className "fa fa-check"}))
                       (dom/h5 nil "1.22.0.0"))
           (dom/button #js {:type "button" :className "btn btn-default" :onClick #(om/transact! (:version owner) "version1_21")}
  ...
  (let [hide #js {:display "none"} color #js {:backgroundColor "green"}]
    (dom/div  #js {:className "animate-switch-container"}
              (dom/div #js {:className "animate-switch" :style
                            (when-not (= (om/get-render-state owner :version) "version2_4") hide)} "not ever1")
              (dom/div #js {:className "animate-switch" :style
                            (when-not (= (om/get-render-state owner :version) "version2_3") hide)} "not ever2")
              (dom/div #js {:className "animate-switch" :style
                            (when-not (= (om/get-render-state owner :version) "version2_2") hide)} "not ever3")
              (dom/div #js {:className "animate-switch" :style
                            (when-not (= (om/get-render-state owner :version) "version2_1") hide)} "not ever4")
              (dom/div #js {:className "animate-switch" :style
                            (when-not (= (om/get-render-state owner :version) "version1_22") hide)} "not ever5")
              (dom/div #js {:className "animate-switch" :style
                            (when-not (= (om/get-render-state owner :version) "version1_21") hide)} "not ever6"))))
